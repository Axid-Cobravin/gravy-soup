...
@SpireInitializer
public class GraveMod implements EditCardsSubscriber, EditCharactersSubscriber, EditStringsSubscriber {
...
//    public static final String HYDRA_SKELETON_JSON = "hydra/idle/dbones/skeleton_ske.json";
    ...
    public static void initialize() {
        BaseMod.addColor(EnumPatch.CYAN, CYAN, CYAN, CYAN, CYAN, CYAN, CYAN, CYAN, makePath(ATTACK_BLUE),
                makePath(SKILL_BLUE), makePath(POWER_BLUE), makePath(ENERGY_ORB_BLUE), makePath(ATTACK_BLUE_PORTRAIT),
                makePath(SKILL_BLUE_PORTRAIT), makePath(POWER_BLUE_PORTRAIT), makePath(ENERGY_ORB_BLUE_PORTRAIT));
    ...
    public void receiveEditStrings() {
        BaseMod.loadCustomStringsFile(PowerStrings.class, "grave_mod/strings/cards.json");
    }
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new Grave(CardCrawlGame.playerName), makePath(HYDRA_BUTTON), makePath(HYDRA_PORTRAIT),
                EnumPatch.HYDRA);
    }
}